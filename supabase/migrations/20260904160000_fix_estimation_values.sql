...
-- importiert und Knut zur Gegenpruefung markiert (siehe Fragenkatalog-Notiz,
-- Korrektur-Log Punkt 7). Knut hat die tatsaechlich im Kurs genannten Werte
-- bestaetigt: 70 % (Frage 22) und 500x (Frage 154). Frage 22 zusaetzlich
-- umformuliert, weil der alte Fragetext den McKinsey-Vergleichswert (30 %)
-- unnoetig mit hineinzog.
